...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_INFO_USER_RIVERSIDEWHITELISTED: `${trusted} Very unlikely to be dangerous according to Riverside's [Dangerous Discord User Database](https://discord.riverside.rocks/)`,
			COMMAND_INFO_USER_RIVERSIDEGOOD: (reportCount) => `${trusted} Unlikely to be dangerous according to Riverside Rocks' [Dangerous Discord User Database](https://discord.riverside.rocks/) (${reportCount} reports)`,
			COMMAND_INFO_USER_RIVERSIDESUSPICIOUS: (reportCount) => `${nodata} Possibly dangerous according to Riverside Rocks' [Dangerous Discord User Database](https://discord.riverside.rocks/) (${reportCount} reports)`,
			COMMAND_INFO_USER_RIVERSIDEBAD: (reportCount) => `${banned} **Likely to be dangerous** according to Riverside Rocks' [Dangerous Discord User Database](https://discord.riverside.rocks/) (${reportCount} reports)`,
